...
<head>
    ...
    <title>ADMIN MULYA</title><link rel="icon" href="images/LOGOU.png" />
</head>
<body>
...
?>
  ...
  <tr>
    ...
    <td><?php echo $data['kapasitas']; ?> PERSON</td>
      ...
      <a class="hapus" href="hapusmejamulya.php?notable=<?php echo $data['notable']; ?>">HAPUS |</a>
      <a class="edit" href="editmejamulya.php?notable=<?php echo $data['notable']; ?>">EDIT</a>					
    </td>
