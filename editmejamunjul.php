...
<nav class="navbar navbar-expand-sm  bg-light  sticky-top">
	...
	<h3>EDIT DATA MUNJUL</h3>

	<?php 
	include "koneksi.php";
	$notable = $_GET['notable'];
	$query_mysql = mysql_query("SELECT * FROM mejamunjul WHERE notable='$notable'")or die(mysql_error());
	
	while($data = mysql_fetch_array($query_mysql)){
	?>
	<form action="updatemejamunjul.php" method="post">		
		<table>
			<tr>
				<td>NO TABLE</td>
				<td>
