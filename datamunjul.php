...
<head>
    ...
    <title>DATA RESERVASI MUNJUL</title><link rel="icon" href="images/LOGOU.png" />
</head>
<body>
    <nav class="navbar navbar-expand-sm  bg-light  sticky-top">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
          <a class="nav-link disabled" href="reservasimunjul.php">BACK TO RESERVASI</a>
          </li>
        </ul>
      </nav>
      ...
      <table class="table table-dark">
		...
		<?php 
		include "koneksi.php";
		$query_mysql = mysql_query("SELECT * FROM bokingmunjul")or die(mysql_error());
		$status="BOOKED";
